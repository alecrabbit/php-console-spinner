...
use AlecRabbit\Spinner\Helper\Benchmark\Factory\BenchmarkingDriverFactory;
use AlecRabbit\Tests\TestCase\TestCaseWithPrebuiltMocksAndStubs;
use PHPUnit\Framework\Attributes\Test;
use PHPUnit\Framework\MockObject\MockObject;
use PHPUnit\Framework\MockObject\Stub;

final class BenchmarkingDriverFactoryTest extends TestCaseWithPrebuiltMocksAndStubs
{
    #[Test]
    public function canBeInstantiated(): void
    {
        ...
        self::assertInstanceOf(BenchmarkingDriverFactory::class, $driverFactory);
    }
    ...
    public function canCreate(): void
    {
        ...
        self::assertInstanceOf(BenchmarkingDriver::class, $result);

        self::assertSame(
            self::getPropertyValue('driver', $result),
            $driver
        );
    }
