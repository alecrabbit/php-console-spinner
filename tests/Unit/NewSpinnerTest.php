    ...
    public function processDataProvider(): array
    {
        return [
            ...
            [
                ...
                [
                    ['\033[?25l1 ' . ucfirst(self::MB_MESSAGE) . Defaults::DEFAULT_SUFFIX . ' \033[14D', []],
                    ['2 ' . ucfirst(self::MB_MESSAGE) . Defaults::DEFAULT_SUFFIX . ' \033[14D', []],
                    ['3 ' . ucfirst(self::MB_MESSAGE) . Defaults::DEFAULT_SUFFIX . ' \033[14D', []],
                    ['4 ' . ucfirst(self::MB_MESSAGE) . Defaults::DEFAULT_SUFFIX . ' \033[14D', []],
                    ['1 ' . ucfirst(self::MB_MESSAGE) . Defaults::DEFAULT_SUFFIX . ' \033[14D', []],
                    ['2 ' . ucfirst(self::MB_MESSAGE) . Defaults::DEFAULT_SUFFIX . ' \033[14D', []],
