...
use AlecRabbit\SpinnerOld\ArrowSpinner;
use AlecRabbit\SpinnerOld\BallSpinner;
use AlecRabbit\SpinnerOld\BlockSpinner;
use AlecRabbit\SpinnerOld\BouncingBarSpinner;
use AlecRabbit\SpinnerOld\CircleSpinner;
use AlecRabbit\SpinnerOld\ClockSpinner;
use AlecRabbit\SpinnerOld\DiceSpinner;
use AlecRabbit\SpinnerOld\Dot8BitSpinner;
use AlecRabbit\SpinnerOld\DotSpinner;
use AlecRabbit\SpinnerOld\EarthSpinner;
use AlecRabbit\SpinnerOld\MoonSpinner;
use AlecRabbit\SpinnerOld\PercentSpinner;
use AlecRabbit\SpinnerOld\SectorsSpinner;
use AlecRabbit\SpinnerOld\Settings\Contracts\Defaults;
use AlecRabbit\SpinnerOld\Settings\Settings;
use AlecRabbit\SpinnerOld\SimpleSpinner;
use AlecRabbit\SpinnerOld\SnakeSpinner;
use AlecRabbit\SpinnerOld\TimeSpinner;
use AlecRabbit\SpinnerOld\WeatherSpinner;
